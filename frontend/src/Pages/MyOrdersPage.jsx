                            ...
                            orders.map((order) => (
                                <tr key={order._id} className='border-b hover:border-gray-50 cursor-pointer'>
                                    <td className='py-2 px-4 sm:py-4 sm:px-4'>
                                        <img src={order.orderItems[0].image} alt={order.orderItems[0].image} 
                                    ...
                                    <td className='py-4 px-2 sm:py-2 sm:px-2 tracking-tighter'>
                                    ...
                                    <td className='py-4 px-2 sm:py-2 sm:px-2 tracking-tighter'>
                                        <span className={`${order.isPaid ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"} px-2 py-2 rounded-full text-xs sm:text-sm font-medium`}>
